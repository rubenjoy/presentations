...
# Git Version Control System <!-- .element: style="text-align: center;font-size: 2em;" -->
...
# Local Version Control Systems
![Local VCS](images/local.png) <!-- .element: width="50%" -->

---

# Centralized Version Control Systems
![Local VCS](images/centralized.png) <!-- .element: width="50%" -->

---

# Distributed Version Control Systems
![Local VCS](images/distributed.png) <!-- .element: width="35%" -->
![Git Logo](images/git-logo.png "Maven Structure") <!-- .element: width="200px" class="fragment bottom-left" -->
...
![Git Snapshots](images/snapshots.png) <!-- .element: width="60%" class="fragment zoom" -->
